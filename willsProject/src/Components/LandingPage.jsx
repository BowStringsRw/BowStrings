...
const Home = ({theme}) => {
    return ( 
        ...
        <div className={theme == "light"? " flex flex-col items-center pb-5 pt-3" : " flex flex-col items-center pt-3 pb-5 md:h-190 bg-[#2d3041]" }>
            {/* the intro page */}
            ...
            <div className="flex flex-col items-center md:flex-row-reverse md:items-start md:mt-6">
                ...
                <p className={theme == "light"? "mx-3 md:mx-0  font-light mt-4 text-sm md:text-30 md:relative md:mt-0  md:w-2/4 md:left-1 md:-translate-full md:translate-y-1/10" : "mx-3 md:mx-0 font-light mt-4 text-sm md:text-30 md:relative md:mt-0 text-white md:w-2/4 md:left-1 md:-translate-full md:translate-y-1/10"}>BowStrings is an initiative by the youth to improve education. We hope to improve education through different ways. We have started to partner with “Let Them Talk,” another youth led initiative that aims at improving communication skills in Rwanda.
            ...
            <div className={theme == "light"? "absolute top-60 left-60 md:top-97 md:left-305 w-20 md:w-35 h-10 text-white bg-white flex" : "absolute top-60 left-60 md:top-97 md:left-305 w-20 md:w-35 h-10 text-white flex"}>
              <div className="bg-blue-500 rounded-sm h-5 md:h-10 flex items-center mr-3"><GraduationCap className="md:w-5  md:h-5" /></div>
              <p className={theme =="light"? "text-gray-500 text-[10px]": "text-white text-[10px]"}>Sholarships Over +1900</p>
            </div>
            {/* dotted img */}
