...
const Footer = ({theme}) => {
    return ( 
        ...
        <div className={theme == "light"? "mx-20 flex flex-col items-center" : "px-20 pt-30 bg-[#2d3041] flex text-gray-300 flex-col items-center" }>
            {/* the subscribe area */}
            <div className= {theme == "light"? "relative bg-[#F3FAFF] w-1/3 flex justify-between  items-center rounded-sm mb-3 shadow shadow-black": "relative bg-[#000000] w-1/3 flex justify-between  items-center rounded-sm mb-3 shadow shadow-black"}>
                ...
                <button className="bg-blue-500 p-3 rounded-sm text-white font-light">Subscribe</button>
            </div>
            {/* socials */}
