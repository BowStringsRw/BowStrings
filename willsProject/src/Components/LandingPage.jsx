    ...
    return ( 
        ...
        <div className={theme == "light"? " flex flex-col items-center pt-3" : " flex flex-col items-center pt-3 pb-5 h-190 bg-[#2d3041]" }>
            ...
            <div className="absolute flex left-210 top-84">
                ...
                <p className={theme == "light"? "text-black": "text-white"}>Congratulations</p>
            </div>
            
            <div className={theme == "light"? "absolute top-97 left-305 w-35 h-10 text-white bg-white flex" : "absolute top-97 left-305 w-35 h-10 text-white flex"}>
              <div className="bg-blue-500 rounded-sm h-10 flex items-center mr-3"><GraduationCap className="w-8 h-6" /></div>
