...
const Homepage2 = ({theme}) => {
    ...
    <>
     ...
     <div className={theme == "light"? "md:mt-30 mx-20 pt-40" : "mt-0 px-20 pt-20 bg-[#161618]" }>
               ...
               {/* all cards */}
               <div className={theme == "light"? "flex flex-col items-center gap-8 md:flex-row md:justify-between" : "flex flex-col md:flex-row justify-between text-white" } >
                {/* card one */}
               <div data-aos="fade-right" className="md:w-1/4 my-4 shadow shadow-gray-400">
                <img src={Pic1} alt="" />
               ...
               {/* card two */}
               <div data-aos="fade-up" className=" md:w-1/4 my-4 shadow shadow-gray-400">
                <img src={Pic1} alt="" />
               ...
               {/* card three */}
               <div data-aos="fade-left" className=" md:w-1/4 my-4 shadow shadow-gray-400">
                <img src={Pic1} alt="" />
                <h2 className="text-sm font-bold my-3 px-2">Essay writing competition</h2>
                <p className="text-sm font-light p-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste nobis cumque corrupti dicta neque cupiditate consectetur, veniam possimus aperiam expedita optio quo, excepturi iusto eius molestiae deleniti ea culpa at.</p>
                <p className="text-blue-500 text0-sm font-light my-2 px-2">See more </p>
               ...
               <div data-aos="fade-left" className="md:flex justify-between items-center mt-10">
                ...
                <div className= {theme == "light"? " md:w-1/2 flex flex-col items-center": " md:w-1/2 text-white" }>
                    <h2 className="text-blue-500 font-bold md:text-2xl my-3 md:mb-10 ">Students be talking about us!</h2>
               ...
               <div className=" my-10 md:flex justify-between">
                ...
                <div className={theme == "light"? " md:grid grid-cols-2 md:w-1/2 gap-10" : "md:grid grid-cols-2 md:w-1/2 gap-10 text-white"}>
                    {/* icon 1 */}
                ...
                <div data-aos="fade-left" className="flex items-center justify-center">
                    <img src={Leaflady} className="mt-16 md:mt-0 md:w-2/2" alt="" />
                </div>
               </div>
               {/* the team intro */}
               ...
               <div className= {theme == "light"? "my-30" : "mt-30 text-white  pb-30"}>
                ...
                <div className=" md:flex md:justify-between">
                    {/* person 1 */}
                    <div className={theme == "light" ? "flex items-center my-6 gap-9 md:w-90 shadow-2xl shadow-black rounded-full":"flex items-center gap-9 my-6 w-70 md:w-90 shadow-2xl shadow-black bg-gray-400 rounded-full"}>
                    ...
                    <div className={theme == "light" ? "flex items-center gap-9 my-6 md:w-90 shadow-2xl shadow-black rounded-full":"flex items-center gap-9 w-70 my-6 md:w-90 shadow-2xl shadow-black bg-gray-400 rounded-full"}>
                        <div className="bg-[#393D3E] w-40">
                            <img src={Profilepic} alt="" />
                        </div>
                        <div className="flex flex-col">
                    ...
                    <div className={theme == "light" ? "flex items-center gap-9 my-6 md:w-90 shadow-2xl shadow-black rounded-full":"flex items-center gap-9 my-6 w-70 md:w-90 shadow-2xl shadow-black bg-gray-400 rounded-full"}>
                        <div className="bg-[#393D3E] w-40">
                            <img src={Profilepic} alt="" />
                        </div>
                        <div className="flex flex-col">
